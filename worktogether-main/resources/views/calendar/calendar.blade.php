...
<div class="my-4">
    ...
    <div class="input-group">
        <?php
                $linkToEventl = config('app.url') . '/calendar/download?user=' . auth()->user()->id;
            ?>
        ...
        <a id="addToCalendar" class="btn btn-dark ml-1" href="{{$linkToEvent}}" target="_blank"
            aria-label="Ajouter au calendrier" rel="noreferrer">
